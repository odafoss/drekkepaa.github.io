...
var sporsmalListe1 = [
    ...
    "Alle legger tlf på bordet, skjerm opp. Første som får vsl, shot, andre 4 slurker, tredje 2 slurker",
    "Alle som ikke føler seg fulle, ta en god slurk nå. FEEEEL GOOD :)",
    "Konkurrer med personen til høyre for deg om å ta den største slurken du klarer",
    "Alle med dialekt må drikke, straffeslurk for å skarre på R'en",
    "Alle med samme farge på toppen som meg må drikke",
    "Hvem hadde du sveipa høyre på på Tinder <3",
    "Hvem er mest fasjonabel her ikveld?",
    "Alle drikker!",
    "Hvem har det fineste smilet?",
    "SKÅÅÅÅL",
...
var sporsmalListe2 = [
    ...
    "alle som er høyere enn DQ (ta en slurk)",
